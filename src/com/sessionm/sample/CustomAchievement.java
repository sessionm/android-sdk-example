...
public class CustomAchievement extends RelativeLayout {
	...
	private class DismissTask extends TimerTask {
		...
		@Override
		public void run() {
			((Activity) CustomAchievement.this.getContext())
		...
		if (animated) {
			...
			if(this.presentationStyle == AchievementPresentationStyle.SLIDE_IN_SLIDE_OUT) {
				dismissAnimation =  AnimationUtils.loadAnimation(
						CustomAchievement.this.getContext(), R.anim.right_to_left);
			} else {
				dismissAnimation =  AnimationUtils.loadAnimation(
						CustomAchievement.this.getContext(), R.anim.scale_down);
			}
			CustomAchievement.this.startAnimation(dismissAnimation);
			dismissAnimation.setAnimationListener(new AnimationListener() {

				@Override
				public void onAnimationEnd(Animation animation) {
					CustomAchievement.this.post(new Runnable() {
	...
	private void finishDismissal() {
		try {
			achievementViewGroup.removeView(CustomAchievement.this);
	...
	private void transition() {
		...
		Animation toBottom = AnimationUtils.loadAnimation(
				CustomAchievement.this.getContext(), R.anim.to_bottom);
				...
				CustomAchievement.this.post(new Runnable() {
					...
					public void run() {
						...
						Animation fromTop = AnimationUtils.loadAnimation(
								CustomAchievement.this.getContext(),
								R.anim.from_top);
